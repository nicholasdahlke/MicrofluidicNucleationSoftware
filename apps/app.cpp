...
int old_main()
{
    ...
    const mfn::Experiment experiment("/home/nicholas/testvideo/700Ul Oel; 10Ul Wasser; 30 Warm; -39 Kalt; 47,8196 Framerate-11222024174140-0000.mp4", 47.82, 1, -10);
...
{
    mfngui::MicrofluidicNucleationGui::main(argc, argv);
}
